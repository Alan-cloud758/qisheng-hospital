...
const navItems = [
  ...
  { path: '/inpatient-admissions', label: '住院入出院' },
  { path: '/beds', label: '病区床位' },
  { path: '/inpatient-detail', label: '住院患者' },
  { path: '/clinical-templates', label: '临床模板' },
  { path: '/cashier', label: '收费工作台' },
  { path: '/insurance-profiles', label: '医保档案' },
  { path: '/insurance-mappings', label: '医保目录' },
  { path: '/insurance-settlements', label: '医保结算' },
